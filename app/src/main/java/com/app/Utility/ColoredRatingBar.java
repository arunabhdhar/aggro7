...
public class ColoredRatingBar extends View {
    ...
    public ColoredRatingBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int type = a.getInt(R.styleable.ColoredRatingBar_type1, 0);
        a.recycle();
    ...
    private void init(Context context) {
        ...
        if(mType==SMALL){
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.mipmap.star_red_small),BitmapFactory.decodeResource(res, R.mipmap.star_orange_small),BitmapFactory.decodeResource(res, R.mipmap.star_green_small)};
            progressBackground = BitmapFactory.decodeResource(res, R.mipmap.star_black_small);
        }else{
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.mipmap.star_red),BitmapFactory.decodeResource(res, R.mipmap.star_orange),BitmapFactory.decodeResource(res, R.mipmap.star_green)};
            progressBackground = BitmapFactory.decodeResource(res, R.mipmap.star_black);
        }
    }
