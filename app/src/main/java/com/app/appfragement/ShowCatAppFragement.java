...
//                    ultimateRecyclerView.showToolbar(toolbar, ultimateRecyclerView, getScreenHeight());
  ...
  private void showCategorizedApp(){
    ...
    private void loadApiGetMethod(String category){
        ...
        String url = "http://oxiloindia.com/aggro/json.php?" + "list_name=topselling_free"+ "&cat_key=" + category + "&country=" + country + "&limit=" + limit + "&page=" + count + "&access_token=" + getActivity().getResources().getString(R.string.aggro_access_token);
