 ...
 */
public class FavCards extends Card {
     ...
     * @param context
     */
    public FavCards(Context context, FavAdapter appLibrary) {
     ...
     * @param innerLayout
     */
    public FavCards(Context context, int innerLayout){
...
//        super.setupInnerViewElements(parent, view);
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FavCards customCards = (FavCards) getCardView().getCard();
